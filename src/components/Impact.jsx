...
const Impact = () => {
  const { t } = useLanguage();
  return (
    <article className="py-32 bg-brand-dark text-brand-light" data-purpose="profile-section" id="about" aria-labelledby="about-title">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row gap-20 items-center">
          <div className="w-full md:w-1/2">
            ...
            <h2 id="about-title" className="text-4xl md:text-6xl font-display italic mb-8">{t('impact.title')}</h2>
          </div>
          <div className="w-full md:w-1/2">
